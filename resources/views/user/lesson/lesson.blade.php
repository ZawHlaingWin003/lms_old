...
@section('content')
    @php
        $navigations = [
            ...
            [
                ...
                "route" => route('show.lesson', ['course' => $course, 'lesson' => $lesson]),
                "active" => true
            ] 
        ]
    @endphp
    ...
    <x-form-container>
            ...
            <h1 class="fw-bold text-secondary pb-4 border-bottom">
                {{ $lesson->lesson_name }}
            </h1>
            <div id="lesson_content" class="mt-5">
                @foreach ($lesson_contents as $lesson_content)
                    {!! $lesson_content->content !!}
                @endforeach
                <div class="d-flex justify-content-center">
                    {!! $lesson_contents->links() !!}
                </div>
            </div>
